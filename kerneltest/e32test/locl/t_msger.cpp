...
// Fileserver
	...
	_S("Kann Schreiben auf Disk nicht abschlie\xDFen"),					// Low power - line2
	_S("Diskfehler - kann Schreiben nicht abschlie\xDFen"),				// Disk error - line1
