...
// approximately 3900 bytes. 
// 
//
 
_LIT8(KTestTxDataZero, "");
_LIT8(KTestTxDataVerySmall, "<< TEST DATA>>");
_LIT8(KTestTxDataSmall, "<> TEST DATA FOR TUTORIAL DEVICE DRIVER >>");
_LIT8(KTestTxDataMedium,"<> TEST DATA FOR TUTORIAL DEVICE DRIVER - PHASE(4):SHARED CHUNKS & MULTITHREAD>>");
...
"We refer to these factory objects as the LDD factory and the PDD factory."\
"We refer to these factory objects as the LDD factory and the PDD factory."\
"We refer to these factory objects0123"\

);
	
//
//  End of t_exchnk_testdata.h
