...
// ifndef __D_EXDMA_PDD_H__ will resolve the multiple inclusion of this 
...
#ifndef __D_EXDMA_PDD_H__
#define __D_EXDMA_PDD_H__
...
//
_LIT(KDriverPddName,"d_exdma.pdd");	// Pdd name
...
#endif // __D_EXDMA_PDD_H__

//
// End of d_exdma_pdd.h