...
//
// Description:
// This is the header file for the PDD. It typically defines 
// DExDriverPhysicalChannel and PDD factory object 
// ifndef __D_EXPIO_PDD_H__ will resolve the multiple inclusion of this 
...
#ifndef __D_EXPIO_PDD_H__
#define __D_EXPIO_PDD_H__
...
//
_LIT(KDriverPddName,"d_expio.pdd");	// Pdd name
...
public:
	// Dfc queue for the driver
	TDynamicDfcQue* iDfcQueue;		
	};

#endif // __D_EXPIO_PDD_H__

//
// End of d_expio_pdd.h
