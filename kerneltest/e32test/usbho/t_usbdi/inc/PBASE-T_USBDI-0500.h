#ifndef __TEST_CASE_PBASE_T_USBDI_0500_H
#define __TEST_CASE_PBASE_T_USBDI_0500_H
...
/**
	...
	@SYMTestCaseID				PBASE-T_USBDI-0500
	@SYMTestCaseDesc			Test resilience to halting an endpoint whilst performing  a bulk IN transfer
	@SYMFssID 
	@SYMPREQ					1305
	...
	@SYMTestActions 			1. Open interfaces to connected device
								2. Request bulk IN transfer
								3. Client halts endpoint
								4. Host clears halt on endpoint (via control transfer request)
								5. Request second bulk IN transfer
								6. Validate data from second bulk IN transfer.
...
class CUT_PBASE_T_USBDI_0500 :  public CBaseBulkTestCase,
								public MTransferObserver,
								public MCommandObserver
	
	{
public:
	static CUT_PBASE_T_USBDI_0500* NewL(TBool aHostRole);
	~CUT_PBASE_T_USBDI_0500(); 
...
private:
	CUT_PBASE_T_USBDI_0500(TBool aHostRole);
	void ConstructL();
...
private:
	...
	*/
	const static TFunctorTestCase<CUT_PBASE_T_USBDI_0500,TBool> iFunctor;
	};
