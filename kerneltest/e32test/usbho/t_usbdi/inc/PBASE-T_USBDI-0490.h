#ifndef __TEST_CASE_PBASE_T_USBDI_0490_H
#define __TEST_CASE_PBASE_T_USBDI_0490_H
...
/**
	...
	@SYMTestCaseID				PBASE-T_USBDI-0490
	@SYMTestCaseDesc			Test for bulk transfers requiring one short packet
	@SYMFssID 
	@SYMPREQ					1305
...
*/
class CUT_PBASE_T_USBDI_0490 :  public CBaseBulkTestCase,
								public MTransferObserver,
								public MCommandObserver
	{
public:
	static CUT_PBASE_T_USBDI_0490* NewL(TBool aHostRole);
	~CUT_PBASE_T_USBDI_0490(); 
...
private:
	CUT_PBASE_T_USBDI_0490(TBool aHostRole);
	void ConstructL();
...
private:
	...
	*/
	const static TFunctorTestCase<CUT_PBASE_T_USBDI_0490,TBool> iFunctor;
	};
