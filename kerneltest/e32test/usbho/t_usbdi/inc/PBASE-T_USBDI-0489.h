#ifndef __TEST_CASE_PBASE_T_USBDI_0489_H
#define __TEST_CASE_PBASE_T_USBDI_0489_H
...
/**
	...
	@SYMTestCaseID				PBASE-T_USBDI-0489
	@SYMTestCaseDesc			
	@SYMFssID 
	@SYMPREQ					1782
	@SYMREQ						
	...
	@SYMTestActions 			1. Open interface on connected device
								...
								3. Cancel the outstanding transfer
...
*/
class CUT_PBASE_T_USBDI_0489 : public CBaseTestCase, public MUsbBusObserver, public MCommandObserver
	{
public:
	static CUT_PBASE_T_USBDI_0489* NewL(TBool aHostRole);
	~CUT_PBASE_T_USBDI_0489(); 
...
private:
	CUT_PBASE_T_USBDI_0489(TBool aHostRole);
	void ConstructL();
...
private:
	...
	*/
	const static TFunctorTestCase<CUT_PBASE_T_USBDI_0489,TBool> iFunctor;
	};
