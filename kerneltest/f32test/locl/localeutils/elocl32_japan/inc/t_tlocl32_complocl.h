...
class LLocaleData
    ...
    // This definition used in timatti builds
    //static const TLocale::NegativeCurrencyFormat TNegativeCurrencyFormat;
    // Corrected type identifier
    static const TLocale::TNegativeCurrencyFormat NegativeCurrencyFormat;
    //old definition (SDK)
    //static const TBool NegativeCurrencyInBrackets;
