...
#if !defined(__OBSERVER_PLUGIN_H__)
#define __OBSERVER_PLUGIN_H__
...
const TInt KObserverPos = 0x20000000;

_LIT(KObserverPluginFileName,"observer_plugin");
_LIT(KObserverPluginName,"ObserverPlugin");

class CObserverPlugin : public CFsPlugin
{

public:
	static CObserverPlugin* NewL();
	~CObserverPlugin();
...
class CObserverPluginConn : public CFsPluginConn
	{
