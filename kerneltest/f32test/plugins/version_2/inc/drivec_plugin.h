...
#if !defined(__DriveC_PLUGIN_H__)
#define __DriveC_PLUGIN_H__
...
const TInt KDriveCPos = 0x2FFFFFFF;

_LIT(KDriveCPluginFileName,"DriveC_plugin");
_LIT(KDriveCPluginName,"DriveCPlugin");

class CDriveCPlugin : public CFsPlugin
{

public:
	static CDriveCPlugin* NewL();
	~CDriveCPlugin();
...
class CDriveCPluginConn : public CFsPluginConn
	{
