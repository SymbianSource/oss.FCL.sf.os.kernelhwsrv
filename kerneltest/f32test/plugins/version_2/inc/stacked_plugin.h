...
#if !defined(__STACKED_PLUGIN_H__)
#define __STACKED_PLUGIN_H__
...
const TInt KStackedPos = 0x50000000;
_LIT(KStackedPluginFileName,"stacked_plugin");
_LIT(KStackedPluginName,"StackedPlugin");

class CStackedPlugin : public CFsPlugin
{

public:
	static CStackedPlugin* NewL();
	~CStackedPlugin();

	virtual void InitialiseL();
	virtual TInt DoRequestL(TFsPluginRequest& aRequest);

	TInt FsPluginDoRequestL(CFsPluginConnRequest& aRequest);
...
class CStackedPluginConn : public CFsPluginConn
	{
